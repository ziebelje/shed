...
l=k.get_bound(),m=k.get_bound_types();if(this.removeEventListener)for(var n=0;m[n];++n)this.removeEventListener(m[n],l,!1);else for(n=0;m[n];++n)this.detachEvent("on"+m[n],l);k.remove_bound()}e[g][h].splice(f,1);if(rocket.isEmpty(e[g][h])){delete e[g][h];rocket.isEmpty(e[g])&&(delete e[g],rocket.isEmpty(rocket.EventTarget.listener_tree_[c])&&delete rocket.EventTarget.listener_tree_[c]);break}f-=1}}}}};
...
c;c=e+b.query_length_-b.length_;0<c&&(e-=c);0>e&&(e=0);c=e+b.query_length_-b.length_;c=b.query_length_-(0<c?c:0);if(e!==b.index_||c!==b.index_length_)b.index_=e,b.index_length_=c,b.query_(e,c)};a.addEventListener("scroll",this.element_scroller_);this.init_sizes_()};
...
rocket.XMLHttpRequest.prototype.abort=function(){if(1<this.readyState){this.request_&&"function"===typeof this.request_.abort&&this.request_.abort();if(this.onabort)this.onabort();this.dispatchEvent("abort");this.removeEventListener();delete this.onreadystatechange;delete this.onabort;this.headers_={};this.status=this.readyState=0;this.responseText=""}};
